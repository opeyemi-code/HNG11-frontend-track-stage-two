...
export default function HeroSection() {
  return (
    <section className="hero-section px-3 px-sm-5 d-flex flex-column flex-sm-row justify-content-between align-items-center pt-5 pt-sm-0">
      ...
      <div className="hero-img-container">
        <img
          className="hero-img"
          src={heroImg}
          alt="Portrait of a lady on dark shade"
        />
      </div>
    </section>
  );
